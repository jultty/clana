...
void gap_regression_solver(Header*, Line*, Line*, tuple<double, double>, Header* correlated);
void range_regression_solver(Header*, Header*, tuple<double, double>, Header* correlated);
